...
if (process.argv.length != 7){
  console.log("Syntax : node transferCoinWithBlueCoinManager.js <org index> <user index> <srcMspId> <dstMspId> <amt>")
  console.log("Example: node transferCoinWithBlueCoinManager.js 1 2 Org1MSP Org2MSP 210")
}else{
